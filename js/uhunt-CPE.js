...
.value('CPE_ExamList', [
  ...
  [{title:'2015/03/24', arr:[
   ...
   {title:'2015/12/22', arr:[
    ['',11332,10487,706,10382,748,10533,11003
  ]]}
  ]},

  {title:'2016', arr:
  [{title:'2016/03/22', arr:[
    ['',11764,10082,10062,406,10106,10026,10032
  ]]},
   {title:'2016/05/24', arr: [
    ['',11942,499,948,10200,11995,10025,11472
  ]]},
   {title:'2016/10/04', arr: [
    ['',11192,1587,10415,11344,12694,439,11624
  ]]},
   {title:'2016/12/20', arr: [
    ['',11364,10242,865,1644,10066,10721,11401
  ]]}
  ]},

  {title:'2017', arr:
  [{title:'2017/03/28', arr:[
    ['',482,10038,496,993,11067,122,1650
  ]]},
   {title:'2017/05/23', arr:[
    ['',1225,12195,10056,1200,12797,1208,1513
  ]]}
  ]}
])
